...
namespace lsp
{
    namespace avx512
    {
        ...
        #define MS_MINMAX_CORE(DST, A, B, OP) \
            ...
            __ASM_EMIT("vmovaps     0x40 + %[CC], %%zmm6")                      /* zmm6 = 0.5f */ \
            __ASM_EMIT("jb          2f")    \
            /* 32x blocks */ \
            __ASM_EMIT("1:") \
            ...
            __ASM_EMIT("vmulps      %%zmm6, %%zmm0, %%zmm0")                    /* zmm0 = O * 0.5f */ \
            __ASM_EMIT("vmulps      %%zmm6, %%zmm1, %%zmm1") \
        ...
        #define MS_SIGN_MINMAX_CORE(DST, A, B, CMP) \
            ...
            __ASM_EMIT("vmovaps     0x40 + %[CC], %%zmm7")                      /* zmm7 = 0.5f */ \
            __ASM_EMIT("jb          2f")    \
            /* 32x blocks */ \
            __ASM_EMIT("1:") \
            __ASM_EMIT("vmovups     0x00(%[" A "], %[off]), %%zmm0")            /* zmm0 = l    */ \
            ...
            __ASM_EMIT("vandps      %%zmm6, %%zmm0, %%zmm4")                    /* zmm4 = fabsf(s) */ \
            ...
            __ASM_EMIT("vmulps      %%zmm7, %%zmm2, %%zmm0")                    /* zmm0 = O * 0.5f */ \
            __ASM_EMIT("vmulps      %%zmm7, %%zmm3, %%zmm1") \
            __ASM_EMIT("vmovups     %%zmm0, 0x00(%[" DST "], %[off])") \
            __ASM_EMIT("vmovups     %%zmm1, 0x40(%[" DST "], %[off])") \
            __ASM_EMIT("add         $0x80, %[off]") \
            __ASM_EMIT("sub         $32, %[count]") \
        ...
        #define MS_ABS_MINMAX_CORE(DST, A, B, OP) \
            ...
            __ASM_EMIT("vmovaps     0x40 + %[CC], %%zmm7")                      /* ymm7 = 0.5f */ \
            __ASM_EMIT("jb          2f")    \
            /* 32x blocks */ \
            __ASM_EMIT("1:") \
            __ASM_EMIT("vmovups     0x00(%[" A "], %[off]), %%zmm0")            /* zmm0 = l    */ \
            ...
            __ASM_EMIT(OP "         %%zmm3, %%zmm1, %%zmm1") \
            __ASM_EMIT("vmulps      %%zmm7, %%zmm0, %%zmm0")                    /* zmm0 = O * 0.5f */ \
