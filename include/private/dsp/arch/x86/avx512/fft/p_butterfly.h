...
#ifndef PRIVATE_DSP_ARCH_X86_AVX512_FFT_P_BUTTERFLY_H_
#define PRIVATE_DSP_ARCH_X86_AVX512_FFT_P_BUTTERFLY_H_

namespace lsp
{
    namespace avx512
    {
        #define FFT_BUTTERFLY_BODY16(fmadd_b, fmadd_a) \
            ARCH_X86_ASM( \
                /* Prepare angle */ \
                ...
                __ASM_EMIT("1:") \
                    ...
                    __ASM_EMIT("vmovups         0x40(%[dst], %[off1]), %%zmm1")     /* zmm1 = a_im */ \
                    __ASM_EMIT("vmovups         0x00(%[dst], %[off2]), %%zmm2")     /* zmm2 = b_re */ \
                    __ASM_EMIT("vmovups         0x40(%[dst], %[off2]), %%zmm3")     /* zmm3 = b_im */ \
                    ...
                    __ASM_EMIT(fmadd_b "        %%zmm6, %%zmm2, %%zmm5")            /* zmm5 = c_re = x_re * b_re +- x_im * b_im */ \
                    __ASM_EMIT(fmadd_a "        %%zmm6, %%zmm3, %%zmm4")            /* zmm4 = c_im = x_re * b_im -+ x_im * b_re */ \
                    /* Perform butterfly */ \
                    ...
                    /* Store values */ \
                    __ASM_EMIT("vmovups         %%zmm0, 0x00(%[dst], %[off1])") \
                    ...
                    __ASM_EMIT("jz              2f") \
                    /* Rotate angle */ \
                    __ASM_EMIT("vmovaps         0x00(%[fft_w]), %%zmm4")            /* zmm4 = w_re */ \
                    __ASM_EMIT("vmovaps         0x40(%[fft_w]), %%zmm5")            /* zmm5 = w_im */ \
...
#endif /* PRIVATE_DSP_ARCH_X86_AVX512_FFT_P_BUTTERFLY_H_ */
