        ...
        static inline void FFT_PSCRAMBLE_SELF_DIRECT_NAME(float *dst, size_t rank)
        {
            ...
            (
                ...
                __ASM_EMIT("1:")
                    ...
                    __ASM_EMIT("vextractf64x4   $1, %%zmm0, 0x80(%[dst], %[off])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm4, 0xa0(%[dst], %[off])")
        ...
        static inline void FFT_PSCRAMBLE_COPY_DIRECT_NAME(float *dst, const float *src, size_t rank)
        {
            ...
            for (size_t i=0; i < regs; ++i)
            {
                ...
                ARCH_X86_ASM(
                    ...
                    __ASM_EMIT("vmovups         %%ymm5, 0x60(%[dst])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm0, 0x80(%[dst])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm4, 0xa0(%[dst])")
