        ...
        static inline void FFT_PSCRAMBLE_SELF_DIRECT_NAME(float *dst, size_t rank)
        {
            ...
            (
                ...
                __ASM_EMIT("1:")
                    ...
                    __ASM_EMIT("vmovups         0x00(%[dst], %[off]), %%zmm0")                  /* zmm0 =  r0  i0  r1  i1  r2  i2  r3  i3  r4  i4  r5  i5  r6  i6  r7  i7   */
                    __ASM_EMIT("vmovups         0x40(%[dst], %[off]), %%zmm1")                  /* zmm1 =  r8  i8  r9  i9 r10 i10 r11 i11 r12 i12 r13 i13 r14 i14 r15 i15   */
                    __ASM_EMIT("vmovups         0x80(%[dst], %[off]), %%zmm4")                  /* zmm4 = r16 i16 r17 i17 r18 i18 r19 i19 r20 i20 r21 i21 r22 i22 r23 i23   */
                    __ASM_EMIT("vmovups         0xc0(%[dst], %[off]), %%zmm6")                  /* zmm6 = r24 i24 r25 i25 r26 i26 r27 i27 r28 i28 r29 i29 r30 i30 r31 i31   */
                    __ASM_EMIT("vcompressps     %%zmm0, %%zmm2 %{%%k5%}")                       /* zmm2 =  i0  i1  i2  i3  i4  i5  i6  i7   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm1, %%zmm3 %{%%k5%}")                       /* zmm3 =  i8  i9 i10 i11 i12 i13 i14 i15   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm4, %%zmm5 %{%%k5%}")                       /* zmm5 = i16 i17 i18 i19 i20 i21 i22 i23   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm6, %%zmm7 %{%%k5%}")                       /* zmm7 = i24 i25 i26 i27 i28 i29 i30 i31   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm0, %%zmm0 %{%%k4%}")                       /* zmm0 =  r0  r1  r2  r3  r4  r5  r6  r7   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm1, %%zmm1 %{%%k4%}")                       /* zmm1 =  r8  r9 r10 r11 r12 r13 r14 r15   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm4, %%zmm4 %{%%k4%}")                       /* zmm4 = r16 r17 r18 r19 r20 r21 r22 r23   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vcompressps     %%zmm6, %%zmm6 %{%%k4%}")                       /* zmm6 = r24 r25 r26 r27 r28 r29 r30 r31   ?   ?   ?   ?   ?   ?   ?   ?   */
                    __ASM_EMIT("vinsertf64x4    $1, %%ymm3, %%zmm2, %%zmm2")                    /* zmm2 =  i0  i1  i2  i3  i4  i5  i6  i7  i8  i9 i10 i11 i12 i13 i14 i15   */
                    __ASM_EMIT("vinsertf64x4    $1, %%ymm7, %%zmm5, %%zmm5")                    /* zmm5 = i16 i17 i18 i19 i20 i21 i22 i23 i24 i25 i26 i27 i28 i29 i30 i31   */
                    __ASM_EMIT("vinsertf64x4    $1, %%ymm1, %%zmm0, %%zmm0")                    /* zmm0 =  r0  r1  r2  r3  r4  r5  r6  r7  r8  r9 r10 r11 r12 r13 r14 r15   */
                    __ASM_EMIT("vinsertf64x4    $1, %%ymm6, %%zmm4, %%zmm4")                    /* zmm4 = r16 r17 r18 r19 r20 r21 r22 r23 r24 r25 r26 r27 r28 r29 r30 r31   */
                    ...
                    __ASM_EMIT("vextractf64x4   $1, %%zmm0, 0x40(%[dst], %[off])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm4, 0x60(%[dst], %[off])")
                    __ASM_EMIT("vmovups         %%ymm2, 0x80(%[dst], %[off])")
                    __ASM_EMIT("vmovups         %%ymm5, 0xa0(%[dst], %[off])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm2, 0xc0(%[dst], %[off])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm5, 0xe0(%[dst], %[off])")
                ...
                __ASM_EMIT("jl              4f")
                    ...
                    __ASM_EMIT("vmovups         %%ymm0, 0x20(%[dst], %[off])")
                    __ASM_EMIT("vmovups         %%ymm3, 0x40(%[dst], %[off])")
                    __ASM_EMIT("vmovups         %%ymm1, 0x60(%[dst], %[off])")
                    /* Move pointers */
        ...
        static inline void FFT_PSCRAMBLE_COPY_DIRECT_NAME(float *dst, const float *src, size_t rank)
        {
            ...
            for (size_t i=0; i < regs; ++i)
            {
                ...
                ARCH_X86_ASM(
                    ...
                    __ASM_EMIT("vextractf64x4   $1, %%zmm0, 0x40(%[dst])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm4, 0x60(%[dst])")
                    __ASM_EMIT("vmovups         %%ymm2, 0x80(%[dst])")
                    __ASM_EMIT("vmovups         %%ymm5, 0xa0(%[dst])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm2, 0xc0(%[dst])")
                    __ASM_EMIT("vextractf64x4   $1, %%zmm5, 0xe0(%[dst])")
