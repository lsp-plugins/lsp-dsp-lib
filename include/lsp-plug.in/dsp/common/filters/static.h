 ...
 */
LSP_DSP_LIB_SYMBOL(void, biquad_process_x1, float *dst, const float *src, float *d, size_t count, LSP_DSP_LIB_TYPE(biquad_t) *f);
 ...
 * @param f bi-quadratic filter structure
 */
LSP_DSP_LIB_SYMBOL(void, biquad_process_x2, float *dst, const float *src, float *d, size_t count, LSP_DSP_LIB_TYPE(biquad_t) *f);
 ...
 * @param f bi-quadratic filter structure
 */
LSP_DSP_LIB_SYMBOL(void, biquad_process_x4, float *dst, const float *src, float *d, size_t count, LSP_DSP_LIB_TYPE(biquad_t) *f);
 ...
 * @param f bi-quadratic filter structure
 */
LSP_DSP_LIB_SYMBOL(void, biquad_process_x8, float *dst, const float *src, float *d, size_t count, LSP_DSP_LIB_TYPE(biquad_t) *f);
 ...
 * @param f bi-quadratic filter structure
 */
LSP_DSP_LIB_SYMBOL(void, biquad_process_x16, float *dst, const float *src, float *d, size_t count, LSP_DSP_LIB_TYPE(biquad_t) *f);
