...
namespace lsp
{
    namespace dsp
    {
         ...
         */
        LSP_DSP_LIB_IMPORT
        void (* center_fft)(float *dst_re, float *dst_im, const float *src_re, const float *src_im, size_t rank);
         ...
         */
        LSP_DSP_LIB_IMPORT
        void (* combine_fft)(float *dst_re, float *dst_im, const float *src_re, const float *src_im, size_t rank);
         ...
         */
        LSP_DSP_LIB_IMPORT
        void (* packed_combine_fft)(float *dst, const float *src, size_t rank);
    }
}
