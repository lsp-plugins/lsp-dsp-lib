...
#ifndef LSP_PLUG_IN_DSP_ARCH_GENERIC_PMATH_ABS_VV_H_
#define LSP_PLUG_IN_DSP_ARCH_GENERIC_PMATH_ABS_VV_H_
...
#endif /* LSP_PLUG_IN_DSP_ARCH_GENERIC_PMATH_ABS_VV_H_ */
