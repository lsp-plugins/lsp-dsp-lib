...
#ifndef LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_TRANSFER_H_
#define LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_TRANSFER_H_
...
#endif /* LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_TRANSFER_H_ */
