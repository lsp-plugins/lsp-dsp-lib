...
#ifndef LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_STATIC_H_
#define LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_STATIC_H_
...
#endif /* LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_STATIC_H_ */
