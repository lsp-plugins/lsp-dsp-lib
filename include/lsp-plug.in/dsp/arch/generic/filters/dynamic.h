...
#ifndef LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_DYNAMIC_H_
#define LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_DYNAMIC_H_
...
#endif /* LSP_PLUG_IN_DSP_ARCH_GENERIC_FILTERS_DYNAMIC_H_ */
