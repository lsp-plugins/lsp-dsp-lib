...
#ifndef LSP_PLUG_IN_DSP_ARCH_X86_AVX2_FLOAT_H_
#define LSP_PLUG_IN_DSP_ARCH_X86_AVX2_FLOAT_H_

#ifndef LSP_PLUG_IN_DSP_ARCH_X86_AVX2_IMPL
    #error "This header should not be included directly"
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_AVX2_IMPL */
...
namespace lsp
{
    namespace avx2
    {
        IF_ARCH_X86(
            ...
            {
                LSP_DSP_VEC8(0x7fffffff),                   // X_ABS
                LSP_DSP_VEC8(0x80000000),                   // X_SIGN
                LSP_DSP_VEC8(0x7f800000),                   // X_P_INF
                LSP_DSP_VEC8(LSP_DSP_FLOAT_SAT_P_NAN_I),    // SX_P_NAN
                LSP_DSP_VEC8(LSP_DSP_FLOAT_SAT_P_INF_I)     // SX_P_INF
            };
        )
        ...
        IF_ARCH_X86(
            ...
            {
                LSP_DSP_VEC8(0x3f800000),      // +1
                LSP_DSP_VEC8(0x7fffffff),      // abs
                LSP_DSP_VEC8(0x80000000),      // sign
                LSP_DSP_VEC8(0x7f800000)       // +Inf
            };
        )
    ...
    #define SANITIZE_BODY(DST, SRC) \
        ...
        IF_ARCH_X86(
            static uint32_t SANITIZE_CVAL[] __lsp_aligned32 =
            {
                LSP_DSP_VEC8(0x7fffffff),            // X_ABS
                LSP_DSP_VEC8(0x80000000),            // X_SIGN
                LSP_DSP_VEC8(0x7f7fffff),            // X_MAX
                LSP_DSP_VEC8(0x007fffff)             // X_MIN
            };
        )
...
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_AVX2_FLOAT_H_ */
