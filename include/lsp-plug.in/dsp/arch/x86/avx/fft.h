...
#include <lsp-plug.in/dsp/arch/x86/avx/fft/butterfly.h>
#include <lsp-plug.in/dsp/arch/x86/avx/fft/normalize.h>
...
#include <lsp-plug.in/dsp/arch/x86/avx/fft/scramble.h>
