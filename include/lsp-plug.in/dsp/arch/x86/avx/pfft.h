...
#ifndef LSP_PLUG_IN_DSP_ARCH_X86_AVX_PFFT_H_
#define LSP_PLUG_IN_DSP_ARCH_X86_AVX_PFFT_H_

#ifndef LSP_PLUG_IN_DSP_ARCH_X86_AVX_IMPL
    #error "This header should not be included directly"
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_AVX_IMPL */

#include <lsp-plug.in/dsp/arch/x86/avx/fft/const.h>
#include <lsp-plug.in/dsp/arch/x86/avx/fft/p_repack.h>
#include <lsp-plug.in/dsp/arch/x86/avx/fft/p_butterfly.h>
...
#include <lsp-plug.in/dsp/arch/x86/avx/fft/p_scramble.h>
...
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_AVX_PFFT_H_ */
