...
#ifndef LSP_PLUG_IN_DSP_ARCH_X86_SSE3_FILTERS_STATIC_H_
#define LSP_PLUG_IN_DSP_ARCH_X86_SSE3_FILTERS_STATIC_H_

#ifndef LSP_PLUG_IN_DSP_ARCH_X86_SSE3_IMPL
    #error "This header should not be included directly"
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_SSE3_IMPL */
    ...
    namespace sse3
    {
        ...
        void x64_biquad_process_x8(float *dst, const float *src, size_t count, dsp::biquad_t *f)
        {
            ...
            (
                ...
                __ASM_EMIT("mulps       0x10 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm9")   // xmm9     = r*i0
                __ASM_EMIT("mulps       0x20 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm2")   // xmm2     = s*a1
                __ASM_EMIT("mulps       0x30 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm10")  // xmm10    = r*i1
                ...
                __ASM_EMIT("mulps       0x50 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm11")  // xmm11    = r*i2
                ...
                __ASM_EMIT("mulps       0x70 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm12")  // xmm12    = r2*j1
                __ASM_EMIT("mulps       0x80 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm5")   // xmm5     = s2*b2
                __ASM_EMIT("mulps       0x90 + " LSP_DSP_BIQUAD_XN_SOFF "(%[f]), %%xmm13")  // xmm13    = r2*j2
...
#endif /* LSP_PLUG_IN_DSP_ARCH_X86_SSE3_FILTERS_STATIC_H_ */
