...
PTEST_BEGIN("dsp.filters", pack_x8, 5, 1000)

    void call(const char * label, dsp::biquad_x8_t *dst, const dsp::biquad_x1_t *src, biquad_pack_x8_t func)
    {
        printf("Testing %s...\n", label);

        PTEST_LOOP(label,
            dsp::biquad_x8_t *d = dst;
