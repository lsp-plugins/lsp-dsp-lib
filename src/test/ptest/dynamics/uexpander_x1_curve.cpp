...
PTEST_BEGIN("dsp.dynamics", uexpander_x1_curve, 5, 1000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            CALL(generic::uexpander_x1_curve);
            IF_ARCH_X86(CALL(sse2::uexpander_x1_curve));
            IF_ARCH_X86(CALL(avx2::uexpander_x1_curve));
            IF_ARCH_X86_64(CALL(avx2::x64_uexpander_x1_curve));
            IF_ARCH_X86(CALL(avx2::uexpander_x1_curve_fma3));
            IF_ARCH_X86_64(CALL(avx2::x64_uexpander_x1_curve_fma3));
            IF_ARCH_X86(CALL(avx512::uexpander_x1_curve));
            IF_ARCH_ARM(CALL(neon_d32::uexpander_x1_curve));
            IF_ARCH_AARCH64(CALL(asimd::uexpander_x1_curve));
            PTEST_SEPARATOR;
        }
