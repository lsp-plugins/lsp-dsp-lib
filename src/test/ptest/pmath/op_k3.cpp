...
PTEST_BEGIN("dsp.pmath", op_k3, 5, 1000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            IF_ARCH_X86(CALL(avx512::add_k3));
            ...
            IF_ARCH_X86(CALL(avx512::mul_k3));
            ...
            IF_ARCH_X86(CALL(avx512::rmod_k3));
