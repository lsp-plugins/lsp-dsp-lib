...
//-----------------------------------------------------------------------------
PTEST_BEGIN("dsp.pmath", minmax3, 5, 2000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            IF_ARCH_X86(CALL(avx512::psmin3));
            ...
            IF_ARCH_X86(CALL(avx512::psmax3));
            ...
            IF_ARCH_X86(CALL(avx512::pamin3));
            ...
            IF_ARCH_X86(CALL(avx512::pamax3));
