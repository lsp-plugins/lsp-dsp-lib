...
//-----------------------------------------------------------------------------
// Performance test
PTEST_BEGIN("dsp.pmath", lerp_vvv, 5, 1000)

    void call(const char *label, float *dst, const float *a, const float *b, const float *k, size_t count, lerp_vvv_t func)
    {
    ...
    PTEST_MAIN
    {
        ...
        #define CALL(func) \
            call(#func, dst, a, b, k, count, func);
