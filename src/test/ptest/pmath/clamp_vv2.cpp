...
//-----------------------------------------------------------------------------
// Performance test
PTEST_BEGIN("dsp.pmath", clamp_vv1, 5, 1000)

    void call(const char *label, float *dst, const float *min, const float *max, size_t count, clamp_vv1_t func)
    {
    ...
    PTEST_MAIN
    {
        ...
        #define CALL(func) \
            ...
            call(#func, dst, min, max, count, func);
