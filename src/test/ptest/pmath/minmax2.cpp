...
//-----------------------------------------------------------------------------
PTEST_BEGIN("dsp.pmath", minmax2, 5, 2000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            IF_ARCH_X86(CALL(avx512::psmin2));
            ...
            IF_ARCH_X86(CALL(avx512::psmax2));
            ...
            IF_ARCH_X86(CALL(avx512::pamin2));
            ...
            IF_ARCH_X86(CALL(avx512::pamax2));
