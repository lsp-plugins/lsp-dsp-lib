...
//                    );
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(call("sse2::eff_hsla_hue", 16, generic::eff_hsla_hue, sse2::eff_hsla_hue, &hue));
        IF_ARCH_X86(call("sse2::eff_hsla_sat", 16, generic::eff_hsla_sat, sse2::eff_hsla_sat, &sat));
        IF_ARCH_X86(call("sse2::eff_hsla_light", 16, generic::eff_hsla_light, sse2::eff_hsla_light, &light));
        IF_ARCH_X86(call("sse2::eff_hsla_alpha", 16, generic::eff_hsla_alpha, sse2::eff_hsla_alpha, &alpha));

        IF_ARCH_X86_64(call("avx2::x64_eff_hsla_hue", 16, generic::eff_hsla_hue, avx2::x64_eff_hsla_hue, &hue));
        IF_ARCH_X86_64(call("avx2::x64_eff_hsla_sat", 16, generic::eff_hsla_sat, avx2::x64_eff_hsla_sat, &sat));
        IF_ARCH_X86_64(call("avx2::x64_eff_hsla_light", 16, generic::eff_hsla_light, avx2::x64_eff_hsla_light, &light));
        IF_ARCH_X86_64(call("avx2::x64_eff_hsla_alpha", 16, generic::eff_hsla_alpha, avx2::x64_eff_hsla_alpha, &alpha));

        IF_ARCH_ARM(call("neon_d32::eff_hsla_hue", 16, generic::eff_hsla_hue, neon_d32::eff_hsla_hue, &hue));
        IF_ARCH_ARM(call("neon_d32::eff_hsla_sat", 16, generic::eff_hsla_sat, neon_d32::eff_hsla_sat, &sat));
        IF_ARCH_ARM(call("neon_d32::eff_hsla_light", 16, generic::eff_hsla_light, neon_d32::eff_hsla_light, &light));
