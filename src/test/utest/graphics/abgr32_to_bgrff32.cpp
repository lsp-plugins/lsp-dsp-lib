...
UTEST_BEGIN("dsp.graphics", abgr32_to_bgrff32)
    void call(const char *label, size_t align, abgr32_to_bgrff32_t func)
    {
...
//        size_t count = 4;
                ...
                24, 25, 30, 31, 32, 46, 47, 48, 49, 64, 65, 100, 768, 999, 1024, 0x1fff)
        {
            for (size_t mask=0; mask <= 0x03; ++mask)
            {
                ...
                // Call functions
                ::abgr32_to_bgrff32(dst1.data(), src, count);
    ...
    UTEST_MAIN
    {
        ...
        CALL(generic::abgr32_to_bgrff32, 16);
        IF_ARCH_X86(CALL(sse2::abgr32_to_bgrff32, 16));
