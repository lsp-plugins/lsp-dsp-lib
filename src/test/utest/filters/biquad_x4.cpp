...
namespace lsp
{
    ...
    typedef void (* biquad_process_t)(float *dst, const float *src, float *d, size_t count, const dsp::biquad_x4_t *f);
...
UTEST_BEGIN("dsp.filters", biquad_x4)
    ...
    void call(const char *label, biquad_process_t func)
    {
        ...
        dsp::biquad_x4_t f2 __lsp_aligned64;
    ...
    void call(const char *label, const dsp::biquad_x4_t *bq, biquad_process_t func1, biquad_process_t func2)
    {
...
//        IF_ARCH_AARCH64(CALL(asimd::biquad_process_x4));
        ...
        x4.b0[0]    = 0.515558779f;
        x4.b0[1]    = 0.878978848f;
        x4.b0[2]    = 0.878978848f;
        x4.b0[3]    = 0.878978848f;

        x4.b1[0]    = -0.994858623f;
        x4.b1[1]    = -1.69613969f;
        x4.b1[2]    = -1.69613969f;
        x4.b1[3]    = -1.69613969f;

        x4.b2[0]    = 0.481613606f;
        x4.b2[1]    = 0.821105599f;
        x4.b2[2]    = 0.821105599f;
        x4.b2[3]    = 0.821105599f;
        ...
        x4.a2[0]    = -0.942126751f;
        x4.a2[1]    = -0.942126751f;
        x4.a2[2]    = -0.942126751f;
        x4.a2[3]    = -0.942126751f;
