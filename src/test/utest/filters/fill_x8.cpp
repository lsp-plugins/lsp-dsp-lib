...
UTEST_BEGIN("dsp.filters", fill_x8)

    void call(const char *label, fcascade_fill_x8_t func)
    {
        ...
        generic::fcascade_fill_x8(dst1.data<dsp::f_cascade_t>(), dst1.data<dsp::f_cascade_t>() + tail_offset);
