...
namespace lsp
{
    ...
    typedef void (*fcascade_fill_x2_t)(dsp::f_cascade_t *h, dsp::f_cascade_t *t);
}

UTEST_BEGIN("dsp.filters", fill_x2)

    void call(const char *label, fcascade_fill_x2_t func)
    {
        ...
        generic::fcascade_fill_x2(dst1.data<dsp::f_cascade_t>(), dst1.data<dsp::f_cascade_t>() + tail_offset);
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(sse::fcascade_fill_x2));
        IF_ARCH_X86(CALL(avx::fcascade_fill_x2));
    }
