...
namespace lsp
{
    ...
    typedef void (*fcascade_fill_x16_t)(dsp::f_cascade_t *h, dsp::f_cascade_t *t);
}

UTEST_BEGIN("dsp.filters", fill_x16)

    void call(const char *label, fcascade_fill_x16_t func)
    {
        ...
        generic::fcascade_fill_x16(dst1.data<dsp::f_cascade_t>(), dst1.data<dsp::f_cascade_t>() + tail_offset);
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(sse::fcascade_fill_x16));
        IF_ARCH_X86(CALL(avx::fcascade_fill_x16));
        IF_ARCH_X86(CALL(avx512::fcascade_fill_x16));
    }
