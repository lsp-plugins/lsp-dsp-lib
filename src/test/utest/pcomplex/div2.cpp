...
UTEST_BEGIN("dsp.pcomplex", div2)
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(generic::pcomplex_div2, sse3::pcomplex_div2, 16));
        IF_ARCH_X86(CALL(generic::pcomplex_rdiv2, sse3::pcomplex_rdiv2, 16));
        ...
        IF_ARCH_X86(CALL(generic::pcomplex_div2, avx512::pcomplex_div2, 64));
        IF_ARCH_X86(CALL(generic::pcomplex_rdiv2, avx512::pcomplex_rdiv2, 64));
