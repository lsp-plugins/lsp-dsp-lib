...
//-----------------------------------------------------------------------------
// Unit test
UTEST_BEGIN("dsp.pmath", ms_minmax2)

    void call(const char *label, size_t align, ms_poper2_t func1, ms_poper2_t func2)
    {
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(generic::ms_pmin2, sse::ms_pmin2, 16));
        IF_ARCH_X86(CALL(generic::ms_pmax2, sse::ms_pmax2, 16));
        IF_ARCH_X86(CALL(generic::ms_psmin2, sse::ms_psmin2, 16));
        IF_ARCH_X86(CALL(generic::ms_psmax2, sse::ms_psmax2, 16));
