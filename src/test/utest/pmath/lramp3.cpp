...
UTEST_BEGIN("dsp.pmath", lramp3)
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(lramp_add3, avx::lramp_add3, 32));
        IF_ARCH_X86(CALL(lramp_sub3, avx::lramp_sub3, 32));
        IF_ARCH_X86(CALL(lramp_rsub3, avx::lramp_rsub3, 32));
        IF_ARCH_X86(CALL(lramp_mul3, avx::lramp_mul3, 32));
        IF_ARCH_X86(CALL(lramp_div3, avx::lramp_div3, 32));
        IF_ARCH_X86(CALL(lramp_rdiv3, avx::lramp_rdiv3, 32));

        IF_ARCH_X86(CALL(lramp_add3, avx512::lramp_add3, 64));
        IF_ARCH_X86(CALL(lramp_sub3, avx512::lramp_sub3, 64));
        IF_ARCH_X86(CALL(lramp_rsub3, avx512::lramp_rsub3, 64));
        IF_ARCH_X86(CALL(lramp_mul3, avx512::lramp_mul3, 64));
        IF_ARCH_X86(CALL(lramp_div3, avx512::lramp_div3, 64));
        IF_ARCH_X86(CALL(lramp_rdiv3, avx512::lramp_rdiv3, 64));
