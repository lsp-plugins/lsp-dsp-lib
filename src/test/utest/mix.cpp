...
UTEST_BEGIN("dsp", mix)
    ...
    UTEST_MAIN
    {
        ...
        IF_ARCH_X86(CALL(generic::mix3, sse::mix3, 16));
        IF_ARCH_X86(CALL(generic::mix4, sse::mix4, 16));
        IF_ARCH_X86(CALL(generic::mix_copy2, sse::mix_copy2, 16));
        IF_ARCH_X86(CALL(generic::mix_copy3, sse::mix_copy3, 16));
        IF_ARCH_X86(CALL(generic::mix_copy4, sse::mix_copy4, 16));
        IF_ARCH_X86(CALL(generic::mix_add2, sse::mix_add2, 16));
        IF_ARCH_X86(CALL(generic::mix_add3, sse::mix_add3, 16));
        IF_ARCH_X86(CALL(generic::mix_add4, sse::mix_add4, 16));

        IF_ARCH_X86(CALL(generic::mix2, avx::mix2, 16));
        IF_ARCH_X86(CALL(generic::mix3, avx::mix3, 16));
        IF_ARCH_X86(CALL(generic::mix4, avx::mix4, 16));
        IF_ARCH_X86(CALL(generic::mix_copy2, avx::mix_copy2, 16));
        IF_ARCH_X86(CALL(generic::mix_copy3, avx::mix_copy3, 16));
        IF_ARCH_X86(CALL(generic::mix_copy4, avx::mix_copy4, 16));
        IF_ARCH_X86(CALL(generic::mix_add2, avx::mix_add2, 16));
        IF_ARCH_X86(CALL(generic::mix_add3, avx::mix_add3, 16));
        IF_ARCH_X86(CALL(generic::mix_add4, avx::mix_add4, 16));

        IF_ARCH_ARM(CALL(generic::mix2, neon_d32::mix2, 16));
        IF_ARCH_ARM(CALL(generic::mix3, neon_d32::mix3, 16));
        IF_ARCH_ARM(CALL(generic::mix4, neon_d32::mix4, 16));
        IF_ARCH_ARM(CALL(generic::mix_copy2, neon_d32::mix_copy2, 16));
        IF_ARCH_ARM(CALL(generic::mix_copy3, neon_d32::mix_copy3, 16));
        IF_ARCH_ARM(CALL(generic::mix_copy4, neon_d32::mix_copy4, 16));
        IF_ARCH_ARM(CALL(generic::mix_add2, neon_d32::mix_add2, 16));
        IF_ARCH_ARM(CALL(generic::mix_add3, neon_d32::mix_add3, 16));
        IF_ARCH_ARM(CALL(generic::mix_add4, neon_d32::mix_add4, 16));

        IF_ARCH_AARCH64(CALL(generic::mix2, asimd::mix2, 16));
        IF_ARCH_AARCH64(CALL(generic::mix3, asimd::mix3, 16));
        IF_ARCH_AARCH64(CALL(generic::mix4, asimd::mix4, 16));
        IF_ARCH_AARCH64(CALL(generic::mix_copy2, asimd::mix_copy2, 16));
        IF_ARCH_AARCH64(CALL(generic::mix_copy3, asimd::mix_copy3, 16));
        IF_ARCH_AARCH64(CALL(generic::mix_copy4, asimd::mix_copy4, 16));
        IF_ARCH_AARCH64(CALL(generic::mix_add2, asimd::mix_add2, 16));
        IF_ARCH_AARCH64(CALL(generic::mix_add3, asimd::mix_add3, 16));
